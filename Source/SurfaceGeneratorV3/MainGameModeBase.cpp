...
void AMainGameModeBase::UpdateChunks_Implementation(int RenderDistance, int ZRenderDistance, FIntVector PlayerChunkLocation) const
{
	...
	for (auto actor : Chunks)
	{
		...
		|| ChunkLocation.Z < PlayerChunkLocation.Z - ZRenderDistance || ChunkLocation.Z > PlayerChunkLocation.Z + ZRenderDistance)
	...
	for (int x = PlayerChunkLocation.X - RenderDistance; x <= PlayerChunkLocation.X + RenderDistance; x++)
		for (int y = PlayerChunkLocation.Y - RenderDistance; y <= PlayerChunkLocation.Y + RenderDistance; y++)
			for (int z = PlayerChunkLocation.Z - ZRenderDistance; z <= PlayerChunkLocation.Z + ZRenderDistance; z++)
